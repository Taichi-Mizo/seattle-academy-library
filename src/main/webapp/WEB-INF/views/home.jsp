...
<script src="resources/js/userId.js" /></script>
                    ...
                    <c:forEach var="bookInfo" items="${bookList}">
                        <div class="books">
                            <form method="post" class="book_thumnail" action="<%=request.getContextPath()%>/details">
                                ...
                                </a> <input type="hidden" name="bookId" value="${bookInfo.bookId}" /> <input type="hidden" name="userId" class="get_userId" value="${userIdGet}" />
                            </form>
                            <ul>
